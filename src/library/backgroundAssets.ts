...
export const BACKGROUND_PATTERNS: BackgroundPattern[] = [
  ...
  },
  {
    ...
    src: makeSvgBackground(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 180"><defs><radialGradient id="g" cx=".5" cy=".5" r=".78"><stop stop-color="#20345c"/><stop offset=".48" stop-color="#121827"/><stop offset="1" stop-color="#070a12"/></radialGradient><filter id="soft"><feGaussianBlur stdDeviation="10"/></filter></defs><rect width="320" height="180" fill="url(#g)"/><g filter="url(#soft)" opacity=".34"><circle cx="92" cy="84" r="34" fill="#a78bfa"><animate attributeName="r" values="28;38;28" dur="8s" repeatCount="indefinite"/></circle><circle cx="226" cy="92" r="42" fill="#a78bfa"><animate attributeName="cy" values="82;104;82" dur="10s" repeatCount="indefinite"/></circle></g><path d="M0 138C52 118 92 122 142 140S250 166 320 128" fill="none" stroke="#f8fafc" stroke-opacity=".08" stroke-width="18"><animate attributeName="d" values="M0 138C52 118 92 122 142 140S250 166 320 128;M0 128C62 150 112 108 160 132S250 152 320 116;M0 138C52 118 92 122 142 140S250 166 320 128" dur="12s" repeatCount="indefinite"/></path></svg>`),
  },
  {
    label: "Golden Veil",
