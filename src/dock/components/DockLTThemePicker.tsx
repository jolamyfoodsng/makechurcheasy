  ...
  return (
    <div className="dock-lt-theme-picker" ref={wrapRef} style={{ position: "relative" }}>
      ...
      >
        ...
        {open ? (
          <DockIcon name="expand_less" size={14} style={{ color: "var(--dock-text-dim)" }} />
        ) : (
          <DockIcon name="expand_more" size={14} style={{ color: "var(--dock-text-dim)" }} />
        )}
      </button>
          ...
          {filteredThemes.map((theme) => (
            ...
            >
              ...
              {favoriteIds.has(theme.id) && (
                <DockIcon name="star" size={11} className="dock-theme-dropdown-item__favorite" />
              )}
            </button>
          ))}
