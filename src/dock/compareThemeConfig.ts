...
export const DEFAULT_COMPARE_THEME_SETTINGS: CompareThemeSettings = {
  ...
  comparePanelBgOpacityLeft: 0.28,
  comparePanelBgOpacityRight: 0.28,
  comparePanelBorderColorLeft: "#334155",
  comparePanelBorderColorRight: "#334155",
  comparePanelBorderWidthLeft: 1,
  comparePanelBorderWidthRight: 1,
  comparePanelRadiusLeft: 4,
  comparePanelRadiusRight: 4,
  comparePanelShadowLeft: true,
  comparePanelShadowRight: true,
...
export function normalizeCompareThemeSettings(source: Record<string, unknown> | null | undefined): CompareThemeSettings {
  ...
  return {
    ...
    comparePanelBgOpacityLeft: numberValue(data, "comparePanelBgOpacityLeft", DEFAULT_COMPARE_THEME_SETTINGS.comparePanelBgOpacityLeft, 0, 1),
    comparePanelBgOpacityRight: numberValue(data, "comparePanelBgOpacityRight", DEFAULT_COMPARE_THEME_SETTINGS.comparePanelBgOpacityRight, 0, 1),
    ...
    comparePanelBorderWidthLeft: numberValue(data, "comparePanelBorderWidthLeft", DEFAULT_COMPARE_THEME_SETTINGS.comparePanelBorderWidthLeft, 0, 12),
    comparePanelBorderWidthRight: numberValue(data, "comparePanelBorderWidthRight", DEFAULT_COMPARE_THEME_SETTINGS.comparePanelBorderWidthRight, 0, 12),
    comparePanelRadiusLeft: numberValue(data, "comparePanelRadiusLeft", DEFAULT_COMPARE_THEME_SETTINGS.comparePanelRadiusLeft, 0, 40),
    comparePanelRadiusRight: numberValue(data, "comparePanelRadiusRight", DEFAULT_COMPARE_THEME_SETTINGS.comparePanelRadiusRight, 0, 40),
    comparePanelShadowLeft: boolValue(data, "comparePanelShadowLeft", DEFAULT_COMPARE_THEME_SETTINGS.comparePanelShadowLeft),
    comparePanelShadowRight: boolValue(data, "comparePanelShadowRight", DEFAULT_COMPARE_THEME_SETTINGS.comparePanelShadowRight),
    compareDividerVisible: boolValue(data, "compareDividerVisible", DEFAULT_COMPARE_THEME_SETTINGS.compareDividerVisible),
