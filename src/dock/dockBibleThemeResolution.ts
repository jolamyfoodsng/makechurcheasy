...
function normalizeQuickThemeSettings(
  ...
  return {
    ...
    refFontWeight: oneOf(source, "refFontWeight", base.refFontWeight, ["light", "normal", "bold"] as const),
    ...
    fontWeight: oneOf(source, "fontWeight", base.fontWeight, ["light", "normal", "bold"] as const),
