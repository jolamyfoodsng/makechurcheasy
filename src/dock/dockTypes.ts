/**
 * dockTypes.ts — Types for the MakeChurchEasy Dock UI
 *
...
export const DOCK_TABS: DockTabDef[] = [
  ...
  { id: "worship", label: "Worship", icon: "music_note", summary: "Manage song lyrics and worship slides" },
...
export interface DockWorshipSection {
  ...
  text: string;
  /** True when this section is currently visible in OBS */
  isVisible?: boolean;
}
