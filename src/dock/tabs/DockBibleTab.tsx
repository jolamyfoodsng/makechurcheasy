...
export default function DockBibleTab({
  ...
  }, [compareLayout, fullscreenLiveOverrides, lowerThirdQuickThemeSettingsLinkedToFullscreen, overlayMode, selectedBibleTheme]);
  ...
  }, [compareLayout, selectedLowerThirdTheme]);
