 ...
 *
 * State slices:
 *   activeContent — What is currently shown
 ...
 *
 * Design principles:
 *   - Single active content track (no preview/program split)
...
export interface BroadcastState {
    ...
    queue: QueueItem[];
    /** Index of the current active item in queue (-1 if none) */
    queueIndex: number;
...
export const INITIAL_BROADCAST_STATE: BroadcastState = {
    ...
    system: {
        ...
        streamPlatformHelper: "General safe recommended",
    },
    libraryTab: "all",
    librarySearch: "",
};
...
export type BroadcastAction =
    // Active content
    | { type: "SET_ACTIVE_CONTENT"; item: ContentItem }
