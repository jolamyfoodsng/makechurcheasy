...
import { deriveSongTitleFromLyrics } from "../../worship/songTitleFromLyrics";
...
export function WorshipModule({
  ...
  }, [hasReachedSongLimit, importMetadata, importLyrics, reloadSongs]);
  ...
  const handleImportLyricsChange = useCallback((nextLyrics: string) => {
    ...
    if (!importTitleWasAutoGeneratedRef.current && importMetadata.title.trim()) return;
