...
export interface BackgroundConfig {
  ...
  color: string;
  /** End color for gradient (for type "gradient") */
  colorEnd?: string;
  /** Gradient angle in degrees (for type "gradient") */
...
// ---------------------------------------------------------------------------
// Region Animation — per-region intro/outro effects
// ---------------------------------------------------------------------------
...
export interface RegionAnimation {
  intro: IntroAnimationType;
  outro: OutroAnimationType;
  durationMs: number;
  easing: AnimationEasing;
}

export const DEFAULT_REGION_ANIMATION: RegionAnimation = {
  intro: "none",
  outro: "none",
  durationMs: 500,
  easing: "ease-out",
...
export const INTRO_ANIMATION_OPTIONS: { value: IntroAnimationType; label: string }[] = [
  ...
  { value: "grow-center", label: "Grow Center" },
  { value: "pop", label: "Pop" },
...
export const OUTRO_ANIMATION_OPTIONS: { value: OutroAnimationType; label: string }[] = [
  { value: "none", label: "None" },
  { value: "fade", label: "Fade" },
  ...
  { value: "slide-up", label: "Slide Up" },
  { value: "slide-down", label: "Slide Down" },
  { value: "shrink-center", label: "Shrink Center" },
  { value: "wipe-left", label: "Wipe Left" },
  { value: "wipe-right", label: "Wipe Right" },
  { value: "wipe-up", label: "Wipe Up" },
  { value: "wipe-down", label: "Wipe Down" },
...
export const ANIMATION_EASING_OPTIONS: { value: AnimationEasing; label: string }[] = [
...
export interface RegionBase {
  ...
  /** Per-region animation config (intro/outro effects) */
...
export interface MVLayout {
  ...
  /** Owner userId for cross-account isolation */
  userId?: string;
}
