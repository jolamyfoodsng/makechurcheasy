                ...
                {items.length === 0 ? (
                    ...
                    items.map((item) => (
                        <LibraryItem
                            key={item.id}
                            item={item}
                            isActive={state.activeContent?.id === item.id}
                            onSetActive={() => setActiveContent(item)}
...
function LibraryItem({ item, isActive, onSetActive, onAddToQueue }: LibraryItemProps) {
    return (
        <div
        ...
        >
            ...
            <div className="library-item-badges">
                {isActive && <span className="library-badge library-badge-active">ACTIVE</span>}
            </div>

            <div className="library-item-actions">
                <button
                    className="library-action-btn library-action-active"
                    onClick={onSetActive}
                    title="Set as Active"
                >
