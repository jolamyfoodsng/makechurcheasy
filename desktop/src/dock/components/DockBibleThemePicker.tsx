...
function themePreviewPoster(settings: BibleThemeSettings): string {
  return settings.boxBackgroundImage || settings.backgroundImage || "";
}
      ...
      >
        ...
        >
          <ThemePreviewSurface
            ...
            videoSrc={displayTheme?.settings.backgroundVideo}
            posterSrc={displayTheme ? themePreviewPoster(displayTheme.settings) : undefined}
