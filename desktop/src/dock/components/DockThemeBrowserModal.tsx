      ...
      <div className="dtb-modal" onClick={(e) => e.stopPropagation()}>
        <div className="dtb-header">
          ...
          <div className="dtb-header__actions">
            <button className="dtb-close-btn" onClick={onClose} aria-label={t('common.close')} title={t('common.close')}>
        ...
        <div className="dtb-search">
          ...
          />
          {search && (
            <button type="button" className="dtb-search__clear" onClick={() => setSearch("")} aria-label={t('common.clear')} title={t('common.close')}>
