...
export const DEFAULT_COMPARE_THEME_SETTINGS: CompareThemeSettings = {
  ...
  compareVerseFontSizeLeft: 80,
  compareVerseFontSizeRight: 80,
  compareReferenceFontSizeLeft: 42,
  compareReferenceFontSizeRight: 42,
  ...
  compareTextAlignLeft: "center",
  compareTextAlignRight: "center",
  ...
  compareVerticalAlignLeft: "center",
  compareVerticalAlignRight: "center",
  ...
  compareReferenceAlignmentLeft: "center",
  compareReferenceAlignmentRight: "center",
...
export function normalizeCompareThemeSettings(source: Record<string, unknown> | null | undefined): CompareThemeSettings {
  ...
  return {
    ...
    compareVerseFontSizeLeft: numberValue(data, "compareVerseFontSizeLeft", DEFAULT_COMPARE_THEME_SETTINGS.compareVerseFontSizeLeft, 18, 200),
    compareVerseFontSizeRight: numberValue(data, "compareVerseFontSizeRight", DEFAULT_COMPARE_THEME_SETTINGS.compareVerseFontSizeRight, 18, 200),
    compareReferenceFontSizeLeft: numberValue(data, "compareReferenceFontSizeLeft", DEFAULT_COMPARE_THEME_SETTINGS.compareReferenceFontSizeLeft, 10, 150),
    compareReferenceFontSizeRight: numberValue(data, "compareReferenceFontSizeRight", DEFAULT_COMPARE_THEME_SETTINGS.compareReferenceFontSizeRight, 10, 150),
    ...
    compareVerticalAlignLeft: stringValue(data, "compareVerticalAlignLeft", DEFAULT_COMPARE_THEME_SETTINGS.compareVerticalAlignLeft, ["center", "bottom"]),
    compareVerticalAlignRight: stringValue(data, "compareVerticalAlignRight", DEFAULT_COMPARE_THEME_SETTINGS.compareVerticalAlignRight, ["center", "bottom"]),
