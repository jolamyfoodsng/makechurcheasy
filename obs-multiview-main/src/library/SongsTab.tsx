...
import { getAllSongs, saveSong, deleteSong } from "../worship/worshipDb";
...
export function SongsTab() {
  ...
  }, [showAddModal, editSong, deleteConfirmId]);
      ...
      {deleteConfirmId && (
        <div className="lib-modal-backdrop" onClick={() => setDeleteConfirmId(null)}>
          <div className="lib-confirm-modal" onClick={(e) => e.stopPropagation()}>
            <h3>Delete Song?</h3>
            <p>This song and its lyrics will be permanently removed.</p>
