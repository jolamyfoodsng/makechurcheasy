...
import { LT_SOURCE_PREFIX, LT_SCENE_NAME, OCS_LT_PATTERN, MV_LT_PATTERN, OCS_BIBLE_LT_PATTERN, LT_SIZE_SCALE, LT_SIZE_WIDTH, LT_SIZE_FONT_SCALE, LT_FONT_SIZE_SCALE, LT_EXIT_STYLE_CSS } from "./types";
...
class LowerThirdObsService {
  ...
  async blankAll(): Promise<void> {
    ...
    await this.pushToAll(theme, this._currentValues, false, true, this._currentSize);
    this._isLive = false;
